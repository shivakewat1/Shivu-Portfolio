      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
            ...
            {categories.map((cat, catIdx) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <h3 className="font-bold text-sm tracking-widest uppercase" style={{ color: '#C9B59C' }}>
                    {cat.title}
                  </h3>
                </div>
                ...
                <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
                  {cat.skills.map((skill, i) => (
                    <motion.div
                      ...
                      className="flex flex-col items-center gap-2 p-3 rounded-2xl transition-all cursor-default group"
                    ...
                    >
                      ...
                      />
                      <span className="text-xs text-center leading-tight" style={{ color: '#5a5a5a' }}>
                        {skill.name}
                      </span>
                    </motion.div>
                  ))}
          ...
          <motion.div
            ...
            className="lg:col-span-2 glass rounded-3xl p-7 sticky top-28"
          >
            <h3 className="font-bold text-sm tracking-widest uppercase mb-8" style={{ color: '#C9B59C' }}>
              Proficiency
            </h3>
              ...
              {proficiency.map(({ label, value }, i) => (
                <div key={label}>
                  <div className="flex justify-between items-center mb-2.5">
                    <span className="text-sm font-medium" style={{ color: '#c0b0a0' }}>{label}</span>
                    <motion.span
                      initial={{ opacity: 0 }}
            ...
            {/* Divider */}
            <div className="my-8 h-px" style={{ background: 'rgba(201,181,156,0.08)' }} />
